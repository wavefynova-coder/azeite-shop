...
              _                 <div className="flex justify-between items-start">
...
                                    <button className="block w-full text-center bg-blue-500/20 text-blue-500 font-semibold py-3 rounded-md hover:bg-blue-500/30 transition-colors">Adicionar ao carrinho</button>
                                </div>
                            </div>
                        </div>
                        
...
                                            ))}
                                        </div>
                                        <a href="#" className="text-blue-500 hover:underline text-sm flex items-center shrink-0">
                                            Ver mais do vendedor <ChevronRightIcon className="w-4 h-4 ml-1" />
Â                                   </a>
                                    </div>
                                </div>
...
                                      t <p>Este kit contém 3 unidades de 250ml cada, perfeito para quem busca qualidade e praticidade na cozinha. A embalagem em vidro escuro protege o azeite da luz, preservando suas propriedades e sabor por mais tempo.</p>
                                    </div>
...
m                             <div className="flex items-center mb-6">
...
                                                <img key={index} src={photo} alt={`Foto de avaliação ${index + 1}`} className="w-20 h-20 object-cover rounded-md cursor-pointer hover:opacity-80 transition-opacity flex-shrink-0"/>
                                            ))}
A                                 </div>
                                    </div>
                                    
...
m                                       <StarRating rating={review.rating} className="w-4 h-4" />
                          _           <p className="text-sm text-gray-500 ml-auto">{review.date}</p>
                                            </div>
...
            </div>
            
            <div className="fixed bottom-0 left-0 right-0 bg-white p-3 border-t border-gray-200 shadow-[0_-2px_10px_rgba(0,0,0,0.1)] z-40 lg:hidden">
                <div className="max-w-6xl mx-auto flex items-center justify-between">
                    <div className="flex items-center space-x-3 overflow-hidden">
                        <img src={productImages[0]} alt="Produto" className="w-10 h-10 object-contain rounded-sm flex-shrink-0" />
code                     <div>
                            <p className="text-sm font-semibold text-gray-800 truncate">Kit 3 Azeite Extra Virgem Gallo</p>
                            <p className="text-lg font-light text-gray-800">R$ 29,90</p>
                        </div>
                    </div>
                    <a href={checkoutUrl} className="bg-blue-500 text-white font-semibold py-2 px-6 rounded-md hover:bg-blue-600 transition-colors flex-shrink-0">Comprar</a>
                </div>
            </div>
        </>
    );
